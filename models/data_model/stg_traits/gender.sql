with cte_id_stitched_identifies as (
    ...
    {{ var('col_ecommerce_identifies_gender')}}, 
...
select distinct {{ var('main_id')}}, 
    first_value({{ var('col_ecommerce_identifies_gender')}}) over(
        ...
        order by case when {{ var('col_ecommerce_identifies_gender')}} is not null and {{ var('col_ecommerce_identifies_gender')}} != '' then 2 else 1 end desc, {{ var('col_ecommerce_identifies_timestamp')}} desc
    ) as gender
