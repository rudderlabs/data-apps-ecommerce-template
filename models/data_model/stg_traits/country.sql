with cte_id_stitched_identifies as (
    ...
    {{ var('col_ecommerce_identifies_country')}}, 
...
select 
    ...
    first_value({{ var('col_ecommerce_identifies_country')}}) over(
        ...
        order by case when {{ var('col_ecommerce_identifies_country')}} is not null and  {{ var('col_ecommerce_identifies_country')}} != '' then 2 else 1 end desc, {{ var('col_ecommerce_identifies_timestamp')}} desc
    ) as country
